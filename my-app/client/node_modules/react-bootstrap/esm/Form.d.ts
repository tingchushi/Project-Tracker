...
import { BsPrefixRefForwardingComponent, AsProp } from 'react-bootstrap/esm/helperststrap/esm/helpers';
...
declare const _default: BsPrefixRefForwardingComponent<"form", FormProps> & {
    Group: BsPrefixRefForwardingComponent<"div", import("react-bootstrap/esm/FormGrouptrap/esm/FormGroup").FormGroupProps>;
    Control: BsPrefixRefForwardingComponent<"input", import("react-bootstrap/esm/FormControlap/esm/FormControl").FormControlProps> & {
        Feedback: BsPrefixRefForwardingComponent<"div", import("react-bootstrap/esm/Feedbackstrap/esm/Feedback").FeedbackProps>;
    };
    Floating: BsPrefixRefForwardingComponent<"div", unknown>;
    Check: BsPrefixRefForwardingComponent<"input", import("react-bootstrap/esm/FormChecktrap/esm/FormCheck").FormCheckProps> & {
        Input: BsPrefixRefForwardingComponent<"input", import("react-bootstrap/esm/FormCheckInputesm/FormCheckInput").FormCheckInputProps>;
        Label: React.ForwardRefExoticComponent<import("react-bootstrap/esm/FormCheckLabelesm/FormCheckLabel").FormCheckLabelProps & React.RefAttributes<HTMLLabelElement>>;
    };
    Switch: BsPrefixRefForwardingComponent<BsPrefixRefForwardingComponent<"input", import("react-bootstrap/esm/FormChecktrap/esm/FormCheck").FormCheckProps> & {
        Input: BsPrefixRefForwardingComponent<"input", import("react-bootstrap/esm/FormCheckInputesm/FormCheckInput").FormCheckInputProps>;
        Label: React.ForwardRefExoticComponent<import("react-bootstrap/esm/FormCheckLabelesm/FormCheckLabel").FormCheckLabelProps & React.RefAttributes<HTMLLabelElement>>;
    }, {
        ...
        feedbackType?: import("react-bootstrap/esm/Feedbackstrap/esm/Feedback").FeedbackType | undefined;
        bsSwitchPrefix?: string | undefined;
    }> & {
        Input: BsPrefixRefForwardingComponent<"input", import("react-bootstrap/esm/FormCheckInputesm/FormCheckInput").FormCheckInputProps>;
        Label: React.ForwardRefExoticComponent<import("react-bootstrap/esm/FormCheckLabelesm/FormCheckLabel").FormCheckLabelProps & React.RefAttributes<HTMLLabelElement>>;
    };
    Label: BsPrefixRefForwardingComponent<"label", import("react-bootstrap/esm/FormLabeltrap/esm/FormLabel").FormLabelProps>;
    Text: BsPrefixRefForwardingComponent<"small", import("react-bootstrap/esm/FormTextstrap/esm/FormText").FormTextProps>;
    Range: React.ForwardRefExoticComponent<import("react-bootstrap/esm/FormRangetrap/esm/FormRange").FormRangeProps & React.RefAttributes<HTMLInputElement>>;
    Select: BsPrefixRefForwardingComponent<"select", import("react-bootstrap/esm/FormSelectrap/esm/FormSelect").FormSelectProps>;
    FloatingLabel: BsPrefixRefForwardingComponent<"div", import("react-bootstrap/esm/FloatingLabel/esm/FloatingLabel").FloatingLabelProps>;
};
