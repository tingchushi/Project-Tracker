...
import { TabPaneProps } from 'react-bootstrap/esm/TabPanetstrap/esm/TabPane';
...
declare const _default: React.FC<TabProps> & {
    Container: {
        ({ transition, ...props }: import("react-bootstrap/esm/TabContainerp/esm/TabContainer").TabContainerProps): JSX.Element;
        propTypes: {
    ...
    Content: import("react-bootstrap/esm/helperststrap/esm/helpers").BsPrefixRefForwardingComponent<"div", unknown>;
    Pane: import("react-bootstrap/esm/helperststrap/esm/helpers").BsPrefixRefForwardingComponent<"div", TabPaneProps>;
};
